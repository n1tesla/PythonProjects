...
class LSTM_AnomalyNetwork(HyperModel):
    ...
    def build(self,hp):
        ...
        lstm1=LSTM(units=hp.Int(f"LSTM_1_units",min_value=100,max_value=256))(input_layer) #128
        ...
        lstm3=LSTM(units=hp.Int(f"LSTM_3_units",min_value=100,max_value=256), return_sequences=True)(repeat_vector) #128
